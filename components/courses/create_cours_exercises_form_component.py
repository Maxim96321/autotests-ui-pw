...
class CreateCourseExercisesForm(BaseComponent):

    def __init__(self, page: Page):
        super().__init__(page)
        self.delete_exercises_button = Button(page,
                                              "create-course-exercise-{index}-box-toolbar-delete-exercise-button",
                                              "Delete exercises")

        self.subtitle = Text(page,
                             "create-course-exercise-{index}-box-toolbar-subtitle-text", "Exercises subtitle"
                             )
    ...
    def click_delete_button(self, index: int):
        self.delete_exercises_button.click(index=index)
