...
@pytest.mark.regression
@pytest.mark.courses
def test_create_course(create_course_page: CreateCoursePage, courses_list_page):
    ...
    create_course_page.image_upload_widget.upload_preview_image("C:/Cours Playwrite/autotest-ui-pw/testdata/files/IMG_4866.png")
